...
description: Validate that all task dependencies are in executed status before proceeding. Use before task execution to ensure prerequisites are met. Halts if any dependency is missing or not executed.
---
