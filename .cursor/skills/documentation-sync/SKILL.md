...
description: Ensure all documentation affected by code changes is updated to reflect current state. Use before committing any task to verify documentation consistency. Creates stubs for undocumented new behavior.
---
