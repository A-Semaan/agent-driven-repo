...
description: Define or update roadmap files in docs/roadmaps/. Use when creating a new roadmap or updating an existing one. Produces structured roadmap documents with phases, context indexes, and file references.
---
